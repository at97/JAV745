...
public class QuestionFive {
    public static void main(String[] args) {
        ...
        System.out.print("Please enter the number of hours worked per month: ");
        double hours = read.nextDouble();

        System.out.print("Please enter the total sales made this month: $");
        ...
        double gross_salary = (wage * hours) + commission;
